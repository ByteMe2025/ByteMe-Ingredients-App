...
def api_call():
    ...
    url = 'https://api.spoonacular.com/recipes/complexSearch?apiKey=1ce7256217df44ba94585d99e4853796&number=50&instructionsRequired=true&addRecipeInformation=true'
    instructions = ''
    try:
