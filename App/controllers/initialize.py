...
def api_call():
    ...
    url = 'https://api.spoonacular.com/recipes/complexSearch?apiKey=4e3b2fc12a714940b03ae344ab792f2d&number=30&instructionsRequired=true&addRecipeInformation=true'
    instructions = ''
    try:
