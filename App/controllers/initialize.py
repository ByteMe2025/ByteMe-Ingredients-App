...
def api_call():
    ...
    url = 'https://api.spoonacular.com/recipes/complexSearch?apiKey=8b6991e23e95474991fc8d46ba4d882a&number=20&instructionsRequired=true&addRecipeInformation=true&addRecipeInstructions=true'
    try:
