...
def api_call():
    ...
    url = 'https://api.spoonacular.com/recipes/complexSearch?apiKey=ceb5a0ec3fe94693b9fe1434a629aea9&number=10&instructionsRequired=true&addRecipeInformation=trueaddRecipeInstructions=true'
    instructions = ''
    try:
