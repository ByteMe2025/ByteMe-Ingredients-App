...
def api_call():
    ...
    url = 'https://api.spoonacular.com/recipes/complexSearch?apiKey=aac4c24f91984b01b2fcfd52970128a5&number=30&instructionsRequired=true&addRecipeInformation=true'
    instructions = ''
    try:
